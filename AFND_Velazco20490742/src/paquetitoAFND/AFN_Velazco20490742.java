...
public class AFN_Velazco20490742 {
    ...
    public static void main(String[] args) {
    	String string = JOptionPane.showInputDialog(null, "Ingrese una cadena que con a, b");
        AFN_Velazco20490742  afnd = new AFN_Velazco20490742 ();
        boolean resultado = afnd.accept(string);
        JOptionPane.showMessageDialog(null, "La cadena " + string + " es " + (resultado ? "aceptada" : "rechazada") + ".");
    }

    public AFN_Velazco20490742 () {
        estadoActual = q0;
    ...
    public boolean accept(String cadena) {
        ...
        return estadosActuales.contains(q8);
    }
